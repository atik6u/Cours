...
<%-- 		<c:set target="${etudiant}" property="nom">KITA</c:set> --%> <!-- Meme que la ligne avant	 -->
		<c:out value="Etudiant apres modif: ${etudiant.nom} ${etudiant.prenom}"></c:out>
	</p>
	
	<!-- Fair la somme de deux parametre recuperes dans une requete GET -->
	<p>
	<c:out value="La somme des deux parametres a et b est: ${result}"></c:out>
	</p>
